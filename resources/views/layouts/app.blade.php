...
<head>
    ...
    <title>@yield('title', 'Klub & Kursus Renang untuk Semua Usia di Kota Jambi - KonservasiAkuatik.space')</title>
    <meta name="description" content="KonservasiAkuatik.space hadir sebagai klub dan kursus renang untuk membantu siapa saja mulai dari balita, anak-anak, remaja, hingga orang tua agar semakin percaya diri dan mampu berenang dengan baik di Kota Jambi.">
    ...
    <meta name="author" content="KonservasiAkuatik.space">
    
    <!-- Open Graph / WhatsApp / Facebook Link Preview -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Klub &amp; Kursus Renang untuk Semua Usia di Kota Jambi - KonservasiAkuatik.space">
    <meta property="og:description" content="Belajar berenang lebih cepat, percaya diri, dan menyenangkan di Kota Jambi bersama KonservasiAkuatik.space.">
    <meta property="og:image" content="{{ asset('images/logo_utama.jpg') }}">

    <!-- Twitter / Messaging Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Klub &amp; Kursus Renang untuk Semua Usia di Kota Jambi - KonservasiAkuatik.space">
    <meta name="twitter:description" content="Belajar berenang lebih cepat, percaya diri, dan menyenangkan di Kota Jambi bersama KonservasiAkuatik.space.">
...
<body class="bg-white text-slate-800 antialiased selection:bg-sky-500 selection:text-white">
    ...
    <div class="announcement-bar">
        <div class="container-custom flex items-center justify-center text-center text-xs sm:text-sm font-medium py-2">
            <span>
                <strong class="font-bold">KonservasiAkuatik.space</strong> • Klub &amp; Kursus Renang untuk Semua Usia di Kota Jambi • 
    ...
    <header class="main-header" id="mainHeader">
        <div class="container-custom flex items-center justify-between py-4">
            ...
            <div class="header-actions">
                <a href="https://wa.me/{{ $whatsappNumber }}?text={{ rawurlencode('Halo KonservasiAkuatik.space, saya ingin bertanya seputar klub dan kursus renang di Kota Jambi.') }}" 
                   target="_blank" 
        ...
        <div class="mobile-drawer hidden" id="mobileDrawer">
            <div class="flex flex-col gap-3.5 px-6 py-6 bg-white border-t border-slate-100 shadow-xl">
                ...
                <a href="https://wa.me/{{ $whatsappNumber }}?text={{ rawurlencode('Halo KonservasiAkuatik.space, saya ingin konsultasi dan mendaftar kursus renang di Kota Jambi.') }}" 
                   target="_blank" 
    ...
    <footer class="main-footer">
        <div class="container-custom py-14 text-center">
            ...
            <div class="pt-6 border-t border-slate-200/80 flex flex-col items-center justify-center text-center text-xs text-slate-500 gap-2.5">
                <p class="text-center">© {{ date('Y') }} KonservasiAkuatik.space. All rights reserved. Kota Jambi.</p>
    ...
    <div class="floating-wa-container">
        <a href="https://wa.me/{{ $whatsappNumber }}?text={{ rawurlencode('Halo KonservasiAkuatik.space, saya ingin konsultasi dan tanya jadwal kursus renang di Kota Jambi.') }}" 
           target="_blank" 
